                                    ...
                                    <div class="relative group mb-3">
                                        ...
                                        <div class="md:hidden absolute inset-0 flex items-center justify-center space-x-4">
                                            <button
                                                ...
                                                class="bg-yellow-500 hover:bg-yellow-600 text-white p-3 rounded-lg shadow-lg z-10"
                                            ...
                                            <button
                                                ...
                                                class="bg-red-500 hover:bg-red-600 text-white p-3 rounded-lg shadow-lg z-10"
