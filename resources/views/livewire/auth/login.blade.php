...
<div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
    ...
    <div class="flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 flex items-center justify-center p-12 relative overflow-hidden">
        ...
        <div class="max-w-md text-center relative z-10">
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-bold text-white mb-4">Seaham Retreats</h1>
    ...
    <div class="flex-1 flex items-center justify-center p-12 bg-gray-50">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="email"
                                   ...
                                   autofocus
                                   autocomplete="email"
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('email') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="password"
                                   ...
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('password') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
