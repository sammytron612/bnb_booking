                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 md:p-6 shadow-md text-center md:text-left">
                            ...
                            <p class="text-gray-700 text-center md:text-left dark:text-gray-300 leading-relaxed">
                                ...
                                <p class="text-gray-700 text-center md:text-left dark:text-gray-300 leading-relaxed">The famous weekly markets showcase local crafts, fresh seafood, and regional specialties, while the nearby countryside offers excellent walking and cycling routes through rolling farmland and along dramatic clifftops.</p>
                                <p class="text-gray-700 text-center md:text-left dark:text-gray-300 leading-relaxed">Whether you're exploring its rich industrial history, hunting for rare seaglass treasures, or simply enjoying the therapeutic sound of waves against limestone cliffs, Seaham invites visitors to experience a unique blend of tradition and tranquility, making it a true gem of the North East coast.</p>
                            </p>
                        </div>
