        ...
        <div class="mb-8 flex justify-between items-start">
            ...
            <div class="flex items-center space-x-4">
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    @csrf
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-red-600 dark:text-red-400">
                            {{ \App\Models\Booking::whereIn('status', ['refunded', 'partial_refund'])->count() }}
                        </span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                        Refunds
