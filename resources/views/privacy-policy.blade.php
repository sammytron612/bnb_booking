    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8">
                ...
                <p class="text-blue-100 mt-2">Last updated: {{ date('F j, Y') }}</p>
            </div>
            ...
            <div class="px-6 py-8 prose prose-lg max-w-none">
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Seaham Coastal Retreats ("we," "our," or "us") operates holiday rental properties in Seaham, County Durham.
                        This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website
                        or book accommodation with us.
                    </p>
                </section>
                ...
                <section class="mb-8">
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <li>Send booking confirmations and check-in information</li>
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">Under data protection laws, you have the right to:</p>
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        ...
                        comply with legal obligations, resolve disputes, and enforce our agreements. Booking records are typically
