            ...
            <div class="w-full lg:w-1/2 h-full">
                ...
                <div class="relative w-full h-full rounded-xl overflow-hidden shadow-xl cursor-pointer"
                    ...
                    <div class="absolute bottom-4 left-4 text-white pointer-events-none">
                        <h3 class="text-xl font-bold mb-1">{{ $featuredImage->title }}</h3>
        ...
        <div class="mt-16 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <button
                        id="openBookingModal"
                        class="w-full bg-blue-600 hover:bg-blue-700 hover:cursor-pointer text-white font-bold py-4 px-8 rounded-lg transition-colors text-lg mb-4"
                    >
