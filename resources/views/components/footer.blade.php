    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-4 text-center sm:text-left">
                ...
                <div class="space-y-3 w-full flex flex-col items-center sm:items-start">
                    {{-- Email --}}
                    @if(config('mail.from.address'))
                    <div class="flex items-center space-x-3 group w-full max-w-xs sm:max-w-none">
                        <div class="w-8 h-8 bg-slate-600 rounded-lg flex items-center justify-center group-hover:bg-blue-600 transition-colors flex-shrink-0">
