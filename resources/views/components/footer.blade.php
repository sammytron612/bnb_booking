                ...
                <div class="mt-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ config('app.facebook_url') }}" target="_blank" rel="noopener noreferrer"
                           class="text-gray-400 p-2 hover:text-blue-500 transition-colors duration-300 transform hover:scale-110"
                           aria-label="Facebook">
                        ...
                        <a href="{{ config('app.instagram_url') }}" target="_blank" rel="noopener noreferrer"
                           class="text-gray-400 p-2 hover:text-pink-500 transition-colors duration-300 transform hover:scale-110"
                        ...
                        <a href="{{ config('app.tripadvisor_url') }}" target="_blank" rel="noopener noreferrer"
                           class="text-gray-400 p-2 hover:text-green-500 transition-colors duration-300 transform hover:scale-110"
                           aria-label="TripAdvisor">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" xml:space="preserve"><path d="M8.311 10.278a2.496 2.496 0 1 0 0 4.992 2.496 2.496 0 0 0 0-4.992zm1.309 2.497a1.309 1.309 0 1 1-1.309-1.309c.723 0 1.309.586 1.309 1.309zm6.069-2.497a2.496 2.496 0 1 0 2.496 2.496 2.497 2.497 0 0 0-2.496-2.496zm1.308 2.497a1.309 1.309 0 1 1-1.309-1.309c.724 0 1.309.586 1.309 1.309z"/><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.689 14.464a3.678 3.678 0 0 1-2.506-.982l-1.182 1.286-1.183-1.287-.006.006a3.69 3.69 0 0 1-4.986-5.439L4.618 8.735h2.683a8.36 8.36 0 0 1 9.406 0h2.676l-1.207 1.313a3.69 3.69 0 0 1-2.487 6.416z"/><path d="M9.23 9.048c1.576.603 2.771 2.012 2.771 3.655 0-1.643 1.195-3.052 2.77-3.655a7.202 7.202 0 0 0-5.541 0z"/></svg>
                        </a>
                    </div>
                </div>
            </div>
